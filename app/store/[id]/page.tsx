    ...
    <div className="min-h-screen bg-[#050505] text-white font-sans flex flex-col pb-24 selection:bg-[#F5A623] selection:text-black relative">
      ...
      <div className="px-5 w-full max-w-xl mx-auto">
        ...
        {activeTab === 'About' && (
          <div className="py-6 space-y-4 animate-in fade-in duration-300">
            ...
            <div className="bg-[#121214] border border-gray-800 rounded-2xl p-5">
              <h3 className="text-[#F5A623] font-black uppercase tracking-widest text-[11px] mb-3">About the Seller</h3>
            ...
            <div className="bg-[#121214] border border-gray-800 rounded-2xl p-5 space-y-4">
              <h3 className="text-white font-black uppercase tracking-widest text-[11px] mb-2">Seller Details</h3>
              ...
              {storeProfile.address && storeProfile.address !== "Address not set" && (
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-gray-500 mt-0.5">{storeProfile.address}</p>
                  </div>
                </div>
              )}
              ...
              {storeProfile.instagram && (
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-[10px] font-bold text-gray-300 uppercase tracking-widest">Instagram</p>
                    <a href={`https://instagram.com/${storeProfile.instagram.replace('@', '')}`} target="_blank" rel="noopener noreferrer" className="text-[10px] text-[#F5A623] hover:underline mt-0.5 inline-block">
        ...
        {activeTab === 'Policies' && (
          <div className="py-6 space-y-4 animate-in fade-in duration-300">
            <div className="bg-[#121214] border border-gray-800 rounded-2xl p-5">
              <h3 className="text-[#F5A623] font-black uppercase tracking-widest text-[11px] flex items-center gap-2 mb-3">
