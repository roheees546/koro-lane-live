  ...
  return (
    <>
      <nav className="fixed bottom-0 w-full max-w-[450px] bg-[#0a0a0c]/95 backdrop-blur-md border-t border-gray-900 flex justify-around items-center px-2 py-4 z-40 pb-6">
        ...
        {/* 1. HOME */}
        <Link href="/" className={`flex flex-col items-center gap-1.5 w-16 ${pathname === '/' ? 'text-[#00e599]' : 'text-gray-500 hover:text-gray-300'}`}>
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
          <span className="text-[9px] font-bold uppercase tracking-widest">Home</span>
        </Link>
        
        {/* 2. SHOP */}
        <Link href="/shop" className={`flex flex-col items-center gap-1.5 w-16 ${pathname === '/shop' ? 'text-[#00e599]' : 'text-gray-500 hover:text-gray-300'}`}>
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"></path></svg>
          <span className="text-[9px] font-bold uppercase tracking-widest">Shop</span>
        </Link>

        {/* 3. LIVE (Updated from FEED) */}
